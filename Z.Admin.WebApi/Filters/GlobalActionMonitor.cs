...
namespace Z.Admin.WebApi.Filters
{
    public class GlobalActionMonitor : ActionFilterAttribute
    {
        ...
        public override void OnResultExecuted(ResultExecutedContext context)
        {
            ...
            try
            {
                ...
                LogEventInfo logEvent = new(NLog.LogLevel.Info, "GlobalActionMonitor", "");

                logEvent.Properties["jsonResult"] = !HttpMethods.IsGet(method) ? jsonResult : "";
