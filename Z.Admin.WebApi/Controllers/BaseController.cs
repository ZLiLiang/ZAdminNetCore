...
namespace Z.Admin.WebApi.Controllers
{
    public class BaseController : ControllerBase
    {
        ...
        protected IActionResult ExportExcel(string path, string fileName)
        {
            ...
            var stream = IOFile.OpenRead(path);//创建文件流
        ...
        private static string GetJsonStr(ApiResult apiResult, string timeFormatStr)
        {
            ...
            return JsonConvert.SerializeObject(apiResult, Formatting.Indented, serializerSetting);
        }
        ...
        {
            IWebHostEnvironment webHostEnvironment = (IWebHostEnvironment)App.ServiceProvider.GetService<IWebHostEnvironment>();
