...
namespace Z.Admin.WebApi.Controllers.System.monitor
{
    ...
    public class MonitorController : BaseController
    {
        ...
        public IActionResult Server()
        {
            ...
            string appRAM = ((double)Process.GetCurrentProcess().WorkingSet64 / 1048576).ToString();
            ...
            string programRunTime = DateTimeHelper.FormatTime((DateTime.Now - programStartTime).TotalMicroseconds.ToString().Split('.')[0].ParseToLong());
            var data = new
            {
