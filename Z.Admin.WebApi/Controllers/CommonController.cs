...
namespace Z.Admin.WebApi.Controllers
{
    ...
    public class CommonController : BaseController
    {
        ...
        public CommonController(IOptions<OptionsSetting> options, IWebHostEnvironment webHostEnvironment, ISysFileService sysFileService)
        {
            this.WebHostEnvironment = webHostEnvironment;
            this.SysFileService = sysFileService;
            this.OptionsSetting = options.Value;
        }
        ...
        public async Task<IActionResult> UploadFile([FromForm] UploadDto uploadDto, StoreType storeType = StoreType.LOCAL)
        {
            ...
            if (formFile == null)
            {
                throw new CustomException(ResultCode.PARAM_ERROR, "上传文件不能为空");
            }
            SysFile file = new();
